...
```{r mean y median steps for day, echo=TRUE}
...
```{r plot mean steps for Interval, echo=TRUE}
...
```{r max steps for Interval, echo=TRUE}
...
```{r missing values, message=TRUE, warning=TRUE, echo=TRUE}
...
```{r mean y median steps without NA for day, echo=TRUE}
...
```{r Error mean y median steps with/without NA for day, echo=TRUE}
...
```{r plot Weekday and weekend, echo=TRUE}
